package com.example.demospringbootdemo.service;
...
import com.example.demospringdemo.model.Survey;
...
public class SurveyService {
	...
	public List<Survey>retrieveAllSureys(){
		return surveys;
	}
	...
	public Question retrieveQuestion(String surveyId,String questionId) {
	  Survey survey =retrieveSurvey(surveyId);
		...
		for(Question question:survey. getQuestions()) {
			if(question.getId().equals(question)){
				return question;
			}
		}
	return null;
